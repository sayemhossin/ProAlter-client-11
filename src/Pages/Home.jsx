    ...
    return (
        <div className="mb-8 overflow-hidden">
            ...
            <div className="text-center md:mb-20 mb-10">
                <h1 data-aos="zoom-in-down" className="text-xl mt-10 md:text-4xl md:mt-20   font-bold text-blue-900">Explore Alternative Products and Enhance Your Choices</h1>
